...
function Layout({ children, theme, onThemeToggle }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-80 bg-white dark:bg-gray-800 shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
